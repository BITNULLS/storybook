...
--------------------------------------------------------
  ...
  ALTER TABLE "SCHOOL" MODIFY ("NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_PROFILE" MODIFY ("USERNAME" NOT NULL ENABLE);
  ...
  ALTER TABLE "USER_PROFILE" MODIFY ("LAST_LOGIN" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "USER_RESPONSE" MODIFY ("USERNAME" NOT NULL ENABLE);
